...
def test_rectify_orders():
    ...
    image, trace_centers, second_order_coefficient_guess = fill_image_with_traces(image, poly_fit_order=4,
                                                                                  max_num_traces=1)
...
def test_rectify_curved_order():
    ...
    rectified_order = extract_utils.rectify_order(image.data, image_coordinates,
