...
def rectify_orders(image_data, trace, half_window=10):
    rectified_orders = {}
...
def rectify_order(image_data, image_coordinates, single_order_centers, half_window=10, null_mapped_values=True):
