...
def mark_features(flux, sigma=3, continuum_formal_error=None, min_feature_width=None, detector_resolution=4):
    """
    :param flux:
    :param sigma:
    ...
    if min_feature_width is None:
        min_feature_width = detector_resolution
    ...
    continuum_estimate = percentile_filter(flux, percentile=-10, size=3 * min_feature_width, mode='nearest')
