...
class MakePDFSummary(Stage):
    ...
    def do_stage(self, image):
        ...
        line_centers = np.array([3969.63, 4862.764, [5185.14, 5174.22, 5168.84], [5891.68, 5897.65], 6564.73, [6709.73, 6709.88]], dtype=object)
        ...
        for ax, line_center, line_name, line_order in zip(axes.flatten(), line_centers, line_names, line_orders):
            ax = make_line_plot(fig, wavelength, flux, order, ax, line_center, line_name, line_order, wavelength_correction = v_over_c_plus_one)
        next_page(pp)
