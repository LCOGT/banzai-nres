...
- Minor fix to have the docker image repo point to ghcr instead of our
...
- Added calibration frame comparison to reject them if they deviate too much
  from previous stacks
...
- Update to use upstream BANZAI version with new version of OCS Ingester
  library (3.0.4)
...
- Bugfix for an incorrect unit conversion in RA from simbad responses during
  classification.
